/*This program is compatiple with all Windows versions (from XP to 11, both 32-bit and 64-bit), but for some reason, it is not with Windows XP 64-bit Edition.
Programmed by "Ali Diaa"*/
